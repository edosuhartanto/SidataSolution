...
namespace Sidata.SLIP2.WebApi.Controllers
{
    ...
    [Tags($"1.Masters - 2.{nameof(InstrumentAccountController)}")]
    [ControllerObjectId(2)]
    public class InstrumentAccountController(
                    IDbContextFactory<LoyaltyDbContext> dbfactory,
                    ICrudDefinition<InstrumentAccount, InstrumentAccountDto> cruddefinition) 
        : WebApiCrudControllerBase<LoyaltyDbContext, InstrumentAccount, InstrumentAccountDto>
