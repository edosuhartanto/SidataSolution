...
namespace Sidata.SLIP2.WebApi.Controllers
{
    ...
    [Tags($"1.Masters - 2.{nameof(LedgerTransactionController)}")]
    [ControllerObjectId(2)]
    public class LedgerTransactionController(
                    IDbContextFactory<LoyaltyDbContext> dbfactory,
                    ICrudDefinition<LedgerTransaction, LedgerTransactionDto> cruddefinition) 
        : WebApiCrudControllerBase<LoyaltyDbContext, LedgerTransaction, LedgerTransactionDto>
