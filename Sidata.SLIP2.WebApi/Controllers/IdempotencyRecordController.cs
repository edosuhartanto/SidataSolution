...
namespace Sidata.SLIP2.WebApi.Controllers
{
    ...
    [Tags($"1.Masters - 2.{nameof(IdempotencyRecordController)}")]
    [ControllerObjectId(2)]
    public class IdempotencyRecordController(
                    IDbContextFactory<LoyaltyDbContext> dbfactory,
                    ICrudDefinition<IdempotencyRecord, IdempotencyRecordDto> cruddefinition) 
        : WebApiCrudControllerBase<LoyaltyDbContext, IdempotencyRecord, IdempotencyRecordDto>
