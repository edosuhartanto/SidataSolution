...
namespace Sidata.SLIP2.WebApi.Controllers
{
    ...
    [Tags($"1.Masters - 2.{nameof(MerchantInstrumentTypeController)}")]
    [ControllerObjectId(2)]
    public class MerchantInstrumentTypeController(
                    IDbContextFactory<LoyaltyDbContext> dbfactory,
                    ICrudDefinition<MerchantInstrumentType, MerchantInstrumentTypeDto> cruddefinition) 
        : WebApiCrudControllerBase<LoyaltyDbContext, MerchantInstrumentType, MerchantInstrumentTypeDto>
