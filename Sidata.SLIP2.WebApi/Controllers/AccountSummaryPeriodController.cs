...
namespace Sidata.SLIP2.WebApi.Controllers
{
    ...
    [Tags($"1.Masters - 2.{nameof(AccountSummaryPeriodController)}")]
    [ControllerObjectId(2)]
    public class AccountSummaryPeriodController(
                    IDbContextFactory<LoyaltyDbContext> dbfactory,
                    ICrudDefinition<AccountSummaryPeriod, AccountSummaryPeriodDto> cruddefinition) 
        : WebApiCrudControllerBase<LoyaltyDbContext, AccountSummaryPeriod, AccountSummaryPeriodDto>
