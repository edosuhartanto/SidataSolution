...
{
    /// <summary>
    /// Class to record a probable double transaction request 
    /// </summary>
    public class IdempotencyRecord : PersistentObject
    {
        #region Properties
        /// <summary>
        ...
        /// <summary>
        /// flag that defined if this idempotency object is already expired or not
        /// </summary>
